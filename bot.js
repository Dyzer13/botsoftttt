...
client.on('ready', () => {                           
client.user.setGame(`.help |.support`,'https://www.twitch.tv/fofodiscord');                                                                                                                                                                                                                                                                                                                                                                                                                            
});
...
let reaction2 = msg.createReactionCollector(reaction2Filter, { time: 12000 });const Discord = require('discord.js');
const client = new Discord.Client();
const convert = require("hh-mm-ss")
const dateFormat = require('dateformat');
const fs = require('fs');
  ...
  const embed = new Discord.RichEmbed()
	  ...
	  .addField('❖-|.clear', `❌لخاصية حذف شات❎`)
       ...
       .addField('❖-|.tempmute', `✅لاعطاء احد ميوت يعني تجعله ما يقدر يرسل ولا شئ لمدة محددة💠`)
          ...
          .addField('❖-|.bc', `✅لكي ترسل لكل ناس في لخاص`)
...
client.on('message', message => {
    let args = message.content.split(' ').slice(1);
if(message.content.split(' ')[0] == '.tcolor'){
